...
flags.DEFINE_string('dataset', './data/images/train.record', 'path to dataset')
flags.DEFINE_string('val_dataset', './data/images/test.record', 'path to validation dataset')
